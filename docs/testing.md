...
| Projects | Nearest account pin, global fallback, full project conversation transfer, interactive-resume writer association, idempotent copy, and panel confirmation | Missing/disabled accounts, ambiguous supervised sessions, conflicting destinations, symlinks, traversal, and failed indexing |
