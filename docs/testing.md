...
| Management | Manual selection, enable/disable, removal archival | Active/default removal blocked; confirmation cancellation preserves data |
...
| Updates | Stable release discovery, caching, atomic replacement, backup | Draft/prerelease/invalid tags, offline/HTTP/JSON errors, checksum mismatch, unsafe archive entries, foreign asset URLs |
